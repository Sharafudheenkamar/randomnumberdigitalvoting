...
class AdminDash(View):
    def get(self, request):
        ...
        return render(request, 'Administrator/admindash.html',{'val': obj,'v':obj1,'v1':obj2,'v2':obj3})
...
class Editcandidate(View):
    def get(self, request,c_id):
        ...
        return render(request, 'Officer/edit.html',{'val':obj})
    def post(self, request, c_id):
        ...
        if form.is_valid():
            ...
            return HttpResponse('''<script>alert("Invalid");window.location="/managecandidate";</script>''')
...
class Managecandidate(View):
    def get(self, request):
        ...
        return render(request, 'Administrator/managecandidate.html',{'val': obj})
...
class Officerdash(View):
    def get(self, request):
        ...
        return render(request, 'Officer/officer.html',{'v1': obj,'v2':obj2})
...
class UserAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        user_data = {
            ...
            "voterid": voter_id  # Assign generated voter ID
        }
        print(user_data)
